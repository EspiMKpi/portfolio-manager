...
| **3** | **Mobile App Development** (Android Studio) | Modern Kotlin / Compose UI & Room Database | ⚪ `NOT_STARTED` | `android-dev`<br/>`kotlin-reviewer`<br/>`kotlin-build-resolver` | TBD | 💻 Laptop (Code & Phone ADB) / 🖥️ PC (AVD) |
...
| **Mobile App** | Compose UI Scaffold, Room DB DAOs | `kotlin-rules`, `verification-loop` |
